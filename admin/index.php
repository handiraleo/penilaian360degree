...
<head>
  ...
  <title>Sistem Penilaian Kompetensi Metode 360 Degree</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php?p=home">
        ...
        <div class="sidebar-brand-text mx-3">E-Comp BSIN</div>
      </a>
	  ...
	  <li class="nav-item <?php $p = $_GET['p']; if($p=='jenisalternatif'){echo "active";} ?>">
        <a class="nav-link" href="index.php?p=jenisalternatif">
          <i class="fas fa-fw fa-users-cog"></i>
          <span>Data Jenis Alternatif</span></a>
      </li>
	  
	  <li class="nav-item <?php $p = $_GET['p']; if($p=='alternatif'){echo "active";} ?>">
        <a class="nav-link" href="index.php?p=alternatif">
          <i class="fas fa-fw fa-users"></i>
          <span>Data Alternatif</span></a>
      </li>
	  
	  <li class="nav-item <?php $p = $_GET['p']; if($p=='kriteria'){echo "active";} ?>">
        <a class="nav-link" href="index.php?p=kriteria">
          <i class="fas fa-fw fa-cube"></i>
          <span>Data Kriteria</span></a>
      </li>
	  
	  <li class="nav-item <?php $p = $_GET['p']; if($p=='subkriteria'){echo "active";} ?>">
        <a class="nav-link" href="index.php?p=subkriteria">
          <i class="fas fa-fw fa-cubes"></i>
          <span>Data Sub Kriteria</span></a>
      </li>
	  
	  <li class="nav-item <?php $p = $_GET['p']; if($p=='periode'){echo "active";} ?>">
