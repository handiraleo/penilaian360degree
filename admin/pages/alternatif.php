		...
		<div class="modal-content">
			...
			<form class="form-horizontal" method="post" action="modal/m_alternatif.php">
				<div class="modal-body">
					...
					<div class="form-group row">
						<label for="nama_karyawan" class="col-sm-2 col-form-label font-weight-bold">Nama</label>
						<div class="col-sm-10">
							<input autocomplete="off" required type="text" class="form-control" id="nama_karyawan" name="nama_karyawan" value="<?= isset($nama_karyawan)?$nama_karyawan:""; ?>">
						</div>
					</div>
					<div class="form-group row">
					...
					<div class="form-group row">
						<label for="status_karyawan" class="col-sm-2 control-form-label font-weight-bold">Status karyawan</label>
						<div class="col-sm-10">
							<input autocomplete="off" required type="text" class="form-control" id="status_karyawan" name="status_karyawan" value="<?= isset($status_karyawan)?$status_karyawan:""; ?>">
						</div>
					</div>
		    ...
		    <div class="modal-body">
		     	<table class="table table-bordered">
					...
					<tr>
						...
						<td id="td_nama_karyawan"></td>
					</tr>

					<tr>
						<th class="bg-light">Status karyawan</th>
		...
		$(".btn_info").click(function(){
			...
			$.ajax({
				...
				success: function(result){
			  		...
			  		$("#td_nama_karyawan").html(res.nama_karyawan);
			  		$("#td_status_karyawan").html(res.status_karyawan);
