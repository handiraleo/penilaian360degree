  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php?p=home">
        ...
        <div class="sidebar-brand-text mx-3">E-Comp 360 DEGREE</div>
      </a>
	  ...
	  <li class="nav-item <?php $p = $_GET['p']; if($p=='memilihpen'){echo "active";} ?>">
	  ...
	  <li class="nav-item <?php $p = $_GET['p']; if($p=='melakukanpen'){echo "active";} ?>">
        <a class="nav-link" href="index.php?p=melakukanpen">
          <i class="fas fa-fw fa-edit"></i>
          <span>Data Penilaian</span></a>
      </li>
	  
	  <li class="nav-item <?php $p = $_GET['p']; if($p=='laporanpen'){echo "active";} ?>">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow mx-1">
			  ...
			  if($_SESSION[md5('level')] == 3 || $_SESSION[md5('level')] == 2 ){
				$sql_a = "SELECT 
						  ...
						  d.nama_karyawan AS 'nama_dinilai',
						  b.nip AS 'nama_penilai',
						  e.nama_karyawan AS 'nama_penilai',
			...
			?>
			  <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				...
				<span class="badge badge-danger badge-counter"><?= $nr_a; ?></span>
				<?php }else if($nr>0){ ?>
				<span class="badge badge-danger badge-counter"><?= $nr; ?></span>
				<?php } ?>
              </a>
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
				...
				<h6 class="dropdown-header bg-danger border border-danger">
                  Pemberitahuan
                </h6>
				<div style="height: 400px; overflow-y: scroll;">
					...
					<a class="dropdown-item d-flex align-items-center" href="index.php?p=melakukanpen&id=<?= $row['id_penilai']; ?>">
					  ...
					  <div>
						<span class="font-weight-bold"><?= $row['nama_karyawan']; ?></span>
					  </div>
					</a>
					<?php
						}
					...
					<div class="dropdown-item disabled font-weight-bold">
					Karyawan yang belum melakukan penilaian: 
					</div>
					<?php
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-danger" href="index.php?logout"><i class="fas fa-fw fa-sign-out-alt mr-1"></i> Keluar</a>
                </div>
            </div>
        </div>
    </div>
