...
<html lang="en">
    <head>
        ...
        <title>Sistem E-Competency Metode 360 Degree</title>
    ...
    <body class="bg-gradient-danger">
        <nav class="navbar navbar-expand-lg navbar-dark bg-white shadow-lg pb-3 pt-3 font-weight-bold">
            <div class="container">
                <a class="navbar-brand text-danger" style="font-weight: 900;" href="index.php"> <i class="fa fa-database mr-2 rotate-n-15"></i> Sistem Pendukung Keputusan Metode 360 Degree</a>
            </div>
        </nav>
            ...
            <div class="row d-plex justify-content-between mt-5">
                                ...
                                <div class="col-lg-12">
                                    <div class="p-5">
                                        ...
                                        <form class="user" action="" method="post">
                                            ...
                                            <button type="submit" class="btn btn-danger btn-user btn-block"><i class="fas fa-fw fa-sign-in-alt mr-1"></i> Masuk</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
				...
				<div class="col-xl-6 col-lg-6 col-md-6 mt-5">
                    <div class="card bg-none o-hidden border-0 my-5 text-white" style="background: none;">
                        <div class="card-body p-0">
                            <h4 style="font-weight: 800;" class="text-justify">Sistem E-Competency Metode 360 Degree</h4>
                            <p class="text-justify pt-4">
                                Sistem pendukung keputusan (SPK) didefinisikan sebagai sebuah sistem yang dimaksudkan untuk mendukung para pengambil keputusan manajerial dalam situasi tertentu.
                            </p>
                            <p class="text-justify">
                                Metode 360 degree merupakan metode dengan penilaian melingkar, sesuatu bisa dinilai berdasarkan penilaian semua faktor yang mempengaruhinya. Metode 360 degree dianggap sebagai penilaian yang efektif bagi organisasi karena penilaian ini didasarkan pada penilaian dari banyak sumber sehingga penilaian lebih bersifat objektif. Penilaian bisa dari pimpinan, bawahan, rekan sejawat dan diri sendiri.
                            </p>
                        </div>
                    </div>
                </div>
