<?php
	...
	if(isset($_POST['btnSimpan'])){
		...
		$karyawan_1 = isset($_POST['karyawan_1'])?mysql_real_escape_string(htmlspecialchars($_POST['karyawan_1'])):"";
		$karyawan_2 = isset($_POST['karyawan_2'])?mysql_real_escape_string(htmlspecialchars($_POST['karyawan_2'])):"";
		$karyawan_3 = isset($_POST['karyawan_3'])?mysql_real_escape_string(htmlspecialchars($_POST['karyawan_3'])):"";
		...
		if($btn=="Tambah"){
			...
			$sql = "INSERT INTO penilai ( nip, id_periode) VALUES('$penilai', '$tahun_penilaian') ";
			...
			if($query){
				...
				$sql2 = "INSERT INTO penilai_detail ( id_penilai, nip) VALUES ('$last_id', '$karyawan_1'), ('$last_id', '$karyawan_2'), ('$last_id', '$karyawan_3'), ('$last_id', '$nip_kepala'), ('$last_id', '$nip_wakil'), ('$last_id', '$penilai') ";
			...
			if($query){
				$last_id = $id_penilai;
				$sql2 = "INSERT INTO penilai_detail ( id_penilai, nip) VALUES ('$last_id', '$karyawan_1'), ('$last_id', '$karyawan_2'), ('$last_id', '$karyawan_3') ";
				$query2 = mysqli_query($con, $sql2);
				if($query2){
					$cek = true;
				}
