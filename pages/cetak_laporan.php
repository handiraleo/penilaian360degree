...
<body>
	<div class="header">
		<h2>Laporan Penilaia Kompetensi Karyawan 360 Degree <?= get_tahun_penilaian(); ?></h2>
		<h1>PT. Bridgestone Tire Indonesia</h1>
		<h3>Jl. Surya Cipta Blalalblabla, Indonesia</h3>
		<br>
		<hr>
	</div>
		...
		<table class="table" border="1" cellspacing="0" cellpadding="5">
			...
			<tbody>
				...
				<tr class="txt_center">
					...
					<td><?= get_tot_nilai($row['nip'], get_tahun_penilaian_id()); ?></td>
				</tr>
				<?php } ?>
			</tbody>
		</table>
