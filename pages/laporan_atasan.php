...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-danger"><i class="fa fa-table"></i> Detail Laporan Penilaian Periode <?= get_tahun_penilaian(); ?></h6>
    </div>
        ...
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
			...
			<tbody>
				...
				<tr align="center">
					...
					<td><?= get_tot_nilai($row['nip'], get_tahun_penilaian_id()); ?>
					</td>
					<td>
