        ...
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
			...
			<tbody>
				<?php
					...
					$sql = "SELECT a.id_penilai, a.nip, c.nama_karyawan, b.id_penilai_detail FROM penilai a JOIN penilai_detail b  ON a.id_penilai = b.id_penilai
...
<?php
	...
	$sql = "SELECT a.id_penilai, a.nip, b.nama_karyawan, c.jabatan FROM penilai a JOIN user b ON a.nip = b.nip JOIN jenis_user c ON b.id_jenis_user = c.id_jenis_user WHERE a.id_penilai = '$id_penilai'";
	$q = mysql_query($sql);
...
<div class="card shadow mb-4">
    <!-- /.card-header -->
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-danger"><i class="fa fa-table"></i> Detail Data</h6>
    </div>
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-danger"><i class="fa fa-table"></i> Detail Data Penilaian</h6>
    </div>
            ...
            <nav class="nav-justified">
			  ...
			  <?php 
                    ...
                    while($row = mysql_fetch_array($q)){
                        ...
                        if($i==0){
                ?>
                    <a class="nav-item nav-link active text-danger" id="nav-home-tab" data-toggle="tab" href="#nav-<?= $row['id_kompetensi']; ?>" role="tab" aria-controls="nav-home" aria-selected="true"><?= $row['nama_kompetensi']; ?></a>
                <?php
                        }else{
                ?>
                    <a class="nav-item nav-link text-danger" id="nav-home-tab" data-toggle="tab" href="#nav-<?= $row['id_kompetensi']; ?>" role="tab" aria-controls="nav-home" aria-selected="true"><?= $row['nama_kompetensi']; ?></a>
                <?php 
                        }
                        $i++;
                    }
